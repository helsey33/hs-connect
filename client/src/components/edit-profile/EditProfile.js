...
class CreateProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.profile.profile) {
      ...
      //If field doesn't exist make empty
            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                ...
                <TextFieldGroup
                  ...
                  info="City or city & state suggested. (eg. Jamshedpur,Jharkhand)"
                />
                ...
                <TextFieldGroup
                  ...
                  onChange={this.onChange}
                  error={errors.skills}
                  info="Please use comma seperated value. (eg. HTML,CSS,JavaScript,React)"
                />
